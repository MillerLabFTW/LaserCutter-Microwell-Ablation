...
#define STRING_CONFIG_H_AUTHOR "(jmil, Jacob Ablative Laser, 2014-08-26)" // Who made the changes.
...
// AMRI Laser Cutter
#define X_MAX_POS 418
#define X_MIN_POS 0
#define Y_MAX_POS 341
#define Y_MIN_POS 0
...
#define DEFAULT_MAX_ACCELERATION      {5000,5000,500,500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
